...
public class MethodApi {
   ...
   public void getPriceList( final IRemoteCallback<ArrayList<RubbishEntity>> callback) {
    ...
    public void getXChangeList(int url,final IRemoteCallback<ListeEntity<XChangeEntity>> callback) {
        final Call<ListeEntity<XChangeEntity>> call = signatureApi.getXchangeList(PV.tokenPrefix+PrefManager.getInstance().getToken(),"/api/shared/exchanges?pageSize=150&pageNumber="+url); // todo
